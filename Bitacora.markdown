...
Lunes, 12 de diciembre: he rellenado y enviado a mi director de la OSL-UNIA Ismael Olea el cuestionario de bienvenida OSL-UNIA. En este cuestionario debía proporcionar datos sobre mi experiencia e inquietudes sobre Open Source y tecnologías, tanto software como hardware. También debía proporcionar información sobre cuáles eran mis nombres de usuario, identificadores y alias de mis distintas páginas web (Taiga, HackLab, Telegram y GitHub), mi nombre y apellidos, el nombre y apellidos de mi tutor (director) de prácticas en empresa, mi número de teléfono móvil, mi carrera actual, la fecha de inicio de las prácticas en empresa, un enlace a mi currículum vitae, y proporcionar un pequeño resumen del tema de mi trabajo de fin de grado que yo tenía planeado hacer para que mi director me lo compatibilice con mis prácticas en empresa.
...
Domingo, 19 de febrero: he agregado más información y detalles a esta bitácora puesto que faltaban algunas cosas importantes por indicar.
